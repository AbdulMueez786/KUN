...
public class home_appliance_adapter extends RecyclerView.Adapter<home_appliance_adapter.MyViewHolder1> {
    ...
    public home_appliance_adapter(Context c, List<Appliance> ls1, HomeFragment.ConnectedThread mConnectedThread1,
